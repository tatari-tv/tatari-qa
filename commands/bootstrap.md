...
For full end-to-end pipeline testing (form → Beeswax order execution),
use a scenario with submit.action: full. The campaign-qa command will
automatically run execute_queued_orders.py after successful form submission.
```
